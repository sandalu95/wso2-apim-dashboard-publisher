...
const rows = [
    ...
    {
        id: 'appcount', numeric: true, disablePadding: false, label: 'APP COUNT',
    },
];
            ...
            <Collapse in={expanded} timeout='auto' unmountOnExit className={classes.collapsef}>
                <div>
                    ...
                    >
                        ...
                        <MenuItem value='appcount'>APP Count</MenuItem>
                    </TextField>
                    <TextField
                        id='query-search'
                        label='Search field'
...
class CustomTable extends React.Component {
    ...
    render() {
        ...
        tableData.forEach((dataUnit) => {
            ...
            creator = dataUnit[0];
            appcount = dataUnit[1];
            ddata.push({ id: counter, creator, appcount });
        });
                                ...
                                .map((n) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell numeric style={{ paddingRight: '10%' }}>{n.appcount}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
