...
const rows = [
    ...
    {
        id: 'apiCalls', numeric: true, disablePadding: false, label: 'API CALLS',
    },
];
...
class CustomTable extends React.Component {
    ...
    render() {
        ...
        tableData.forEach((dataUnit) => {
            ...
            user = dataUnit[0];
            apiCalls = dataUnit[1];
            ddata.push({ id: counter, user, apiCalls });
        });
                                ...
                                .map((n) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell numeric style={{ paddingRight: '10%' }}>{n.apiCalls}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
