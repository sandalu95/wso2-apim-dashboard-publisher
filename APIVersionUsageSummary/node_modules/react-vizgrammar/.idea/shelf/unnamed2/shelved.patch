...
<+>UTF-8
===================================================================
--- samples/chart-docs/BarChartSamples.jsx	(date 1536329503000)
+++ samples/chart-docs/BarChartSamples.jsx	(date 1536328739663)
@@ -88,6 +88,9 @@
                     mode: 'stacked',
                 },
             ],
...
+
+        this.timeData2 = [
+            [new Date('2015-02-01 00:00:00.000').getTime(), 150000, 'Product 1'],
+            [new Date('2015-02-02 00:00:00.000').getTime(), 100000, 'Product 2'],
+            [new Date('2015-02-03 00:00:00.000').getTime(), 150000, 'Product 1'],
+            [new Date('2015-02-04 00:00:00.000').getTime(), 100000, 'Product 2'],
+        ];
+
+
+        this.ChartConfig =
