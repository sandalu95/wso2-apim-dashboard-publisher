...
var Widget = function (_Component) {
    ...
    function Widget(props) {
        ...
        _this.channelManager = props.channelManager;
        return _this;
    }
    ...
    _createClass(Widget, [{
            ...
            if (!publisherId) {
                ...
                if (publisherIds && Array.isArray(publisherIds)) {
                    publisherIds.forEach(function (id) {
                        return _this2.props.pubSubHub.subscribe(id, listenerCallback);
                    });
                }
            } else {
         ...
         * @returns {{}}
         */
        value: function getGlobalState(key) {
        ...
        key: 'setGlobalState',
        value: function setGlobalState(key, state) {
        ...
        key: 'getWidgetConfiguration',
        value: function getWidgetConfiguration(widgetId) {
        ...
        value: function _getStateObject() {
            ...
            return hash === '' || hash === '#' ? {} : JSON.parse(hash.substr(1));
        }
