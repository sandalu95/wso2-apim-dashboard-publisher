        ...
        >
            <div className={classes.title}>
                <Typography variant='h6' id='tableTitle'>
                    <FormattedMessage id='table.heading' defaultMessage='APP CREATED TIMES' />
                </Typography>
            </div>
...
/**
 * Create React Component for APP Created Times Table
 */
class CustomTable extends React.Component {
    ...
    render() {
        ...
        tableData.forEach((dataUnit) => {
            counter += 1;
            dataNew.push({ id: counter, appname: dataUnit[0], createdtime: dataUnit[1] });
        });
